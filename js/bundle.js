...
function timer (id, deadline) {
    ...
    function getTimeRemaining(endtime) {
        ...
        if (t <= 0) {
            ...
            seconds = 0;
              ...
              days = Math.floor(t / (1000 * 60 * 60 * 24)), // миллисекунды * к-во секунд в минуте * к-во минут в часе * к-во часов в дне
    ...
    function setClock (selector, endtime){
        ...
        const timer = document.querySelector(selector),
            ...
            updateClock(); // ЧТОБЫ НЕ МОРГАЛА ДАТА
...
window.addEventListener('DOMContentLoaded', () => {
    const modalTimerId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__.openModal)('.modal', modalTimerId), 5000); // ТАЙМЕР ВСПЛЫТИЯ ОКНА ПРИ ВХОДЕ НА СТРАНИЦУ

    (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_0__["default"])('.tabheader__item', '.tabcontent', '.tabheader__items', 'tabheader__item_active');
    (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__["default"])('[data-modal]', '.modal', modalTimerId);
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2022-11-14');
